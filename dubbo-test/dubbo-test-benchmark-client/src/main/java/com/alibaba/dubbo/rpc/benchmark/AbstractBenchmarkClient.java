...
public abstract class AbstractBenchmarkClient {
    ...
    public void run(String[] args) throws Exception {
        ...
        final String serialization =properties.getProperty("serialization");
        ...
        startInfo.append(",protocol is: ").append(protocol);
        startInfo.append(",serialization is: ").append(serialization);
        ...
        for (int i = 0; i < concurrents; i++) {
            ClientRunnable runnable = getClientRunnable(protocol, serialization, serverIP, serverPort, clientNums, timeout, barrier, latch,
                                                        beginTime, endtime);
    ...
    public abstract ClientRunnable getClientRunnable(String protocol, String serialization, String targetIP, int targetPort, int clientNums, int rpcTimeout,
